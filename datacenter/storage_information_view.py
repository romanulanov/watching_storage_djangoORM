...
def storage_information_view(request):
    ...
    for num, visit in enumerate(visits):
        non_closed_visits.append({'who_entered': non_closed_names[num], 'entered_at': localtime(visit.entered_at), 'duration':  format_duration(visit.get_duration()), 'is_strange': visit.is_visit_long()})
